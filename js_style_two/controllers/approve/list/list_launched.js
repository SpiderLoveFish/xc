...
function approveInit(listType) {
	...
	if (listType == 'leave') {
		type = 'getMyList_Leave';
		getData('getMyList_Leave');
	} else if (listType == 'work') {
		type = 'getMyList_Work';
		getData('getMyList_Work');
	} else if (listType == 'projecthour') {
		type = 'getMyList_projecthour';
		getData('getMyList_projecthour');
	} else if (listType == 'generalapprove') {
		type = 'getMyList_generalapprove';
		getData('getMyList_generalapprove');
	} else if (listType == 'all') {
		type = 'getMyList_All';
		getData('getMyList_All');
	}
	//重置上拉加载
